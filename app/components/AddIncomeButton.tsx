  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 text-sm font-semibold text-emerald-600 border border-emerald-200 rounded-lg hover:bg-emerald-50 transition-colors"
      >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm mx-4">
            ...
            <h2 className="text-lg font-bold mb-1">Add Income</h2>
            <p className="text-sm text-neutral-500 mb-4">Manually log income that wasn&apos;t automatically tracked.</p>
